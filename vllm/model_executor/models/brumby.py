...
# Copyright 2025 The ManifestAI team.
...
from vllm.transformers_utils.configs import BrumbyConfig
...
class BrumbyDecoderLayer(nn.Module):
    def __init__(
        ...
        self.self_attn = BrumbyRetention(
...
class BrumbyModel(Qwen2Model):
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        super().__init__(
            vllm_config=vllm_config, prefix=prefix, decoder_layer_type=BrumbyDecoderLayer
        )
